...
module.exports = class {
  ...
  async execute(queries, from, to, parse = true) {
    ...
    const res = await fetch(url, { method: 'POST', headers: { 'Content-Type': 'application/json', authorization }, body: JSON.stringify(payload) });
