...
exports.buildQuery = (carId) => [
  {
    ...
    refId: 'vs2',
    rawSql: `SELECT odometer, inside_temp, driver_temp_setting, fan_status, is_climate_on, date FROM positions WHERE date > CURRENT_DATE - INTERVAL '30 days' AND car_id = ${carId} ORDER BY date DESC LIMIT 1`
  }, {
    refId: 'charge',
    rawSql: `
